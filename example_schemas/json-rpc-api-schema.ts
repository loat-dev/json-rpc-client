import type { OpenRpcDocument } from '../src/open_rpc/open_rpc_document.ts';
  ...
  "methods": [
    ...
    },
    {
      ...
      "result": {
        ...
        "schema": {
          "type": "array",
          "items": {
            "$ref": "#/components/schemas/user_ban"
          }
        }
      }
    },
      ...
      "params": [
        {
          ...
          "schema": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/incoming_ip_ban"
            }
          }
        }
      ],
    ...
    },
    {
      ...
      "result": {
        "name": "status",
        "schema": {
          "$ref": "#/components/schemas/server_state"
        }
      }
    },
    {
    ...
    },
    {
      ...
      "result": {
        "name": "mode",
        "schema": {
          "$ref": "#/components/schemas/game_type"
        }
      }
    },
    {
    ...
    },
    {
      ...
      "name": "minecraft:serversettings/simulation_distance",
      "params": [],
      "result": {
        "name": "distance",
        "schema": {
    ...
    },
    {
      ...
      "name": "minecraft:serversettings/entity_broadcast_range",
      "params": [],
      "result": {
    ...
    },
    {
      ...
      "result": {
        ...
        "schema": {
          "type": "array",
          "items": {
            "$ref": "#/components/schemas/typed_game_rule"
          }
        }
      }
    },
      ...
      "params": [
        {
          ...
          "required": true,
          "schema": {
            "$ref": "#/components/schemas/untyped_game_rule"
          }
        }
      ],
      "result": {
